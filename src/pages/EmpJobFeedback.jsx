  ...
  const handleSubmit = async () => {
    ...
    payload.append("comment", comment);
      ...
      if (res.ok) {
        ...
        navigate("/emp/feedback-success/"); // redirect to success page
      } else {
        ...
        <div className="col-span-12 md:col-span-6 bg-white rounded-2xl shadow p-6">
         ...
         {!hasRated && (
              <button
                ...
                className="mt-6 w-full bg-blue-500 text-white py-4 rounded-xl text-lg font-semibold"
              >
                Submit Feedback
              </button>
            )}
