      ...
      <div className="relative bg-white shadow-sm pb-20">
        <div className="relative z-10 container mx-auto px-4 pt-6">
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            ...
            <div onClick={() => navigate("/work-history/new")} className="bg-white rounded-lg shadow text-center p-4">
              <span className="block text-lg font-bold">{profile.Waiting}</span>
              <span className="text-sm text-gray-500 uppercase">New Work</span>
            </div>
            <div onClick={() => navigate("/work-history/inprogress")} className="bg-white rounded-lg shadow text-center p-4">
            ...
            <div onClick={() => navigate("/work-history/completed")} className="bg-white rounded-lg shadow text-center p-4">
